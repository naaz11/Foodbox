...
const routes: Routes = [
  {path:'', component:HomeComponent}, // '' is the landing page for the application
  ...
  {path: 'products/product/:id', component:ProductPageComponent}, //localhost:4200/products/product/id
